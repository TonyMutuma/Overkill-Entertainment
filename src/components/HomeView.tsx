...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="w-full bg-[#070b11] text-white selection:bg-red-600 selection:text-white">
      {/* 1. Hero Section */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden px-6 md:px-16 pt-12 pb-16">
        ...
        <div className="relative z-10 max-w-[1280px] w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            {/* Red Eyebrow Label */}
            <span className="text-red-500 font-mono text-xs uppercase tracking-[0.25em] font-semibold mb-4">
              OVERKILL ENTERTAINMENT
            </span>

            {/* Main Headline */}
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl font-normal leading-[1.08] tracking-tight mb-6 text-white max-w-2xl">
              Unforgettable Sounds. Flawless Experiences.
            </h1>

            {/* Subtitle */}
            <p className="font-sans text-slate-300 text-lg md:text-xl max-w-lg mb-10 leading-relaxed font-light">
            ...
            <div className="flex flex-wrap items-center gap-6 mb-16">
              <button
                ...
                className="bg-white text-black font-semibold text-sm px-7 py-4 rounded-none hover:bg-slate-200 transition-all duration-200 cursor-pointer flex items-center gap-2 uppercase tracking-wider"
              >
                Book Your Date
              ...
              <button
                ...
                className="text-white font-semibold text-sm px-4 py-4 hover:text-red-500 transition-colors duration-200 cursor-pointer uppercase tracking-wider underline underline-offset-8"
              >
                Explore Mixes
              </button>
            </div>
            ...
            {/* Stat Counters Bar */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pt-8 border-t border-slate-800/80 w-full max-w-2xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono uppercase tracking-wider text-slate-400 mt-1">Mixes Recorded</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono uppercase tracking-wider text-slate-400 mt-1">Events Powered</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono uppercase tracking-wider text-slate-400 mt-1">Happy Clients</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono uppercase tracking-wider text-slate-400 mt-1">Sound & Equipment</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#04060a] py-12 border-t border-slate-900 relative z-10">
        <div className="max-w-[1280px] mx-auto px-6 md:px-16 text-center">
          <p className="font-mono text-xs text-slate-500 uppercase tracking-[0.3em] mb-8">
            TRUSTED BY
          </p>
      ...
      <section className="py-24 px-6 md:px-16 max-w-[1280px] mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="font-mono text-xs text-red-500 uppercase tracking-[0.25em] mb-2 block">
            THE OVERKILL DIFFERENCE
          </span>
          <h2 className="font-serif text-3xl md:text-5xl text-white tracking-tight font-normal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#0b0f17] p-8 md:p-12 border border-slate-800/60 relative">
            ...
            <h3 className="font-serif text-2xl md:text-3xl font-normal mb-4 text-white">
              The Problem
            </h3>
            <p className="font-sans text-slate-400 mb-6 leading-relaxed font-light">
          ...
          <div className="bg-[#0b0f17] p-8 md:p-12 border border-slate-700 relative">
            ...
            <p className="font-sans text-slate-300 mb-6 leading-relaxed font-light">
      ...
      <section className="py-24 bg-[#04060a] border-y border-slate-900">
        <div className="max-w-[1280px] mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-normal text-white mb-4">
              Why Choose Overkill?
            </h2>
            <p className="font-sans text-slate-400 max-w-xl mx-auto font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-[#0b0f17] border border-slate-800 relative min-h-[220px] flex items-center p-8 overflow-hidden">
              ...
              <div className="relative z-10 max-w-lg">
                <span className="text-red-500 font-mono text-[11px] uppercase tracking-widest block mb-2">
                  Hardware & Rig
                </span>
                <h3 className="font-serif text-2xl font-normal mb-2 text-white">
                  Concert-Tier Setup
                </h3>
                <p className="font-sans text-slate-400 font-light text-sm leading-relaxed">
      ...
      <section className="py-24 px-6 md:px-16 max-w-[1280px] mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-sans text-slate-400 font-light">
          ...
          <table className="w-full text-left border-collapse min-w-[650px]">
            <thead>
              <tr className="border-b border-slate-800">
                <th className="p-6 font-serif text-lg text-slate-300 w-1/3 font-normal">Feature</th>
                <th className="p-6 font-serif text-lg text-slate-500 w-1/3 text-center font-normal">
                  Playlist Apps / Average DJs
                </th>
                <th className="p-6 font-serif text-lg text-red-500 w-1/3 text-center bg-red-950/20 border-x border-slate-800 font-normal">
            ...
            <tbody className="font-sans text-sm">
              {COMPARISON_TABLE.map((row, i) => (
                <tr key={i} className="border-b border-slate-800/60 last:border-0 hover:bg-slate-900/30 transition-colors">
                  <td className="p-6 text-slate-200">{row.feature}</td>
                  <td className="p-6 text-center text-slate-500">{row.standardDjs}</td>
                  <td className="p-6 text-center text-white bg-red-950/10 border-x border-slate-800 font-medium">
                    {row.overkill}
                  </td>
                </tr>
              ))}
        ...
        <div className="mt-14 text-center">
          <button
            onClick={handleBooking}
            className="bg-white text-black font-semibold text-sm px-8 py-4 rounded-none hover:bg-slate-200 transition-all duration-200 cursor-pointer uppercase tracking-wider inline-flex items-center gap-2"
          >
