...
export const DJ_ASSETS = {
  heroBg: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?q=80&w=1920&auto=format&fit=crop',
...
export const TRUST_VENUES = [
  { name: 'THE ROXY', location: 'West Hollywood' },
  { name: 'AVALON', location: 'Hollywood' },
  { name: 'EXCHANGE', location: 'Downtown LA' },
  { name: 'SOUND', location: 'Hollywood' },
  { name: 'ACADEMY', location: 'Los Angeles' },
  { name: 'THE VANGUARD', location: 'Orlando' },
];
...
export const MIX_TRACKS: MixTrack[] = [
  {
    ...
    categoryLabel: 'Club',
    duration: '1h 45m',
    recordedAt: 'Recorded live at The Vanguard',
    ...
    audioKey: 'tech-house',
    tags: ['Tech House', 'Bassline', 'Peak Hour', '128 BPM'],
    tracklistSnippet: [
  ...
  },
  {
    ...
    duration: '2h 10m',
    recordedAt: 'Recorded live at SV Tech Pavilion',
  ...
  {
    id: 'mix-3',
    title: 'Mainstage Mayhem',
    category: 'festival',
    categoryLabel: 'Festival',
    duration: '1h 00m',
    recordedAt: 'Recorded live at Nocturnal Arena Stage',
    ...
    tags: ['Festival Electro', 'Speed House', 'Mainstage', '130 BPM'],
    tracklistSnippet: [
  ...
  },
  {
    ...
    duration: '1h 30m',
    recordedAt: 'Recorded live at Skybar Rooftop',
    description: 'Breezy golden-hour grooves moving seamlessly into infectious rhythmic house and nu-disco.',
    date: 'Jul 22, 2024',
    plays: '15.8k Plays',
    bpm: 124,
  ...
  },
  {
    ...
    duration: '2h 45m',
    recordedAt: 'Recorded live at Bel-Air Estate',
    description: 'Uncompromising open-format brilliance. Timeless classics, neo-soul, high-energy 90s/00s, and modern chart heaters.',
    date: 'Jun 18, 2024',
    plays: '9.7k Plays',
    bpm: 118,
    imageUrl: DJ_ASSETS.luxuryWedding,
    audioKey: 'wedding-openformat',
    tags: ['Open Format', 'Soul & Funk', 'Chart Bangers', 'Multi-Genre'],
    tracklistSnippet: [
      '01. Earth Wind & Fire - September (Modern Bassline Blend)',
      '02. Beyonce - Cuff It (Wolverine Extended Cut)',
      '03. Usher - Yeah! (Live Wordplay Transition into 2024 Trap)',
      '04. Dua Lipa - Levitating (Club Remix)',
  ...
  },
  {
    ...
    categoryLabel: 'Club',
    duration: '1h 15m',
    recordedAt: 'Recorded live at Warehouse District LA',
